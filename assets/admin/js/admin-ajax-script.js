(function (window, document, $, undefined) {
    ...
    $('.upow-backorder-options-fields,.upow-variations-swatches-options-fields,.upow-preorder-options-fields,.upow-one-click-checkout-options-fields,.upow-sorting-manager-options-fields').on('click', 'input, select, textarea', function() {
    ...
    */
    ...
    $(document).ready(function($) {
        $('.upow-one-click-checkout-options-fields').on('submit', function(e) {
            e.preventDefault();
            
            var formData = $(this).serialize();
            formData += '&action=upow_quick_checkout_fields_save_options';
            formData += '&nonce=' + upow_localize_obj.nonce;
    ...
    $(document).ready(function($) {
        $('.upow-sorting-manager-options-fields').on('submit', function(e) {
            e.preventDefault();
            
            var formData = $(this).serialize();
            formData += '&action=upow_sorting_manager_fields_save_options';
            formData += '&nonce=' + upow_localize_obj.nonce;
